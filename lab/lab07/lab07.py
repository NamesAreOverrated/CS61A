...
def subseqs(s):
    ...
    if not s:
        ...
        sub_seqs = subseqs(s[1:])
        return sub_seqs + insert_into_all(s[0], sub_seqs)
...
def make_glookup(class_assignments):
    ...
    def make_student(key, grade):
        nonlocal target_grade, total_point
        total_point += grade
        target_grade += class_assignments[key]
        return total_point/target_grade
    return make_student
