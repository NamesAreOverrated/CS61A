...
def make_withdraw(balance, password):
    ...
    def withdraw(amount, enter_password):
        ...
        if len(error_passwords) > 2:
            return f'Too many incorrect attempts. Attempts: {error_passwords}'
        if enter_password != password:
            if enter_password not in error_passwords:
                error_passwords.append(enter_password)
